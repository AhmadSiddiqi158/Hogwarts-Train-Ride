public class TrainRide {
	...
	public static TrainNetwork generateTrainNetwork() {
		...
		//TrainStation next =l1.travelOneStation(s5, s4);
		

		/*
		 * System.out.println(l1.toString());
		 * 
		 * //System.out.println(l1.getLeftTerminus().getName());
		 * System.out.println("----------------------------");
		 * 
		 * l1.shuffleLine(); System.out.println(l1.toString());
		 * 
		 * System.out.println("----------------------------"); // System.out.
		 * println("now im getting the link of the second station in the shuffled Array"
		 * ); l1.sortLine(); System.out.println("----------------------------");
		 */
		  
		 // System.exit(0);
		/*
		 * System.out.println(l1.getRightTerminus().getName());
		 * 
		 * System.out.println(l1.toString());
		 * 
		 * System.out.println("\n\n\n\n");
		 * 
		 * System.out.println("Now we Sort our Train stations");
		 */
